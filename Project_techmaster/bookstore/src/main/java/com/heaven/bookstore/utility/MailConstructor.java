package com.heaven.bookstore.utility;
...
public class MailConstructor {
    ...
    public SimpleMailMessage constructResetTokenEmail(String contextPath, Locale locale,String token
        ...
        String message = "\nPlease click on this link to verify your email and edit your info. Your password is: " + password;
        SimpleMailMessage email = new SimpleMailMessage();
        email.setTo(user.getEmail());
        email.setSubject("Lee's BookStore - new User");
    ...
    public MimeMessagePreparator constructOrderConfirmationEmail(User user,Order order,Locale local){
        ...
        MimeMessagePreparator messagePreparator = new MimeMessagePreparator() {
            ...
            public void prepare(MimeMessage mimeMessage) throws Exception {
                ...
                email.setFrom(new InternetAddress("quangstore1@gmail.com"));
            }
        };
