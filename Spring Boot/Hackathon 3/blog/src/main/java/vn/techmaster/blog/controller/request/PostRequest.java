...
public class PostRequest {
  ...
  private Set<Tag> tags;
    ...
    public PostRequest(@NotNull @Size(min = 10, max = 300, message = "title must be with 10 and 300") String title, @NotNull @Size(min = 20, max = 5000, message = "content must be with 20 and 5000") String content, Set<Tag> tags) {
        this.title = title;
